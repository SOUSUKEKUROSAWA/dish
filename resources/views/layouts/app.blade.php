...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div id="app">
            ...
            <footer>
                <div class="logo-text">
                    <a href="https://twitter.com/so_webeng" target="_blank" rel="noopener noreferrer">
                        <img id="logo-image" src="{{asset("/img/twitter_logo.png")}}">
                    </a>
                    <a class="btn bubble-name" href="https://twitter.com/so_webeng" target="_blank" rel="noopener noreferrer">Developer</a>
                </div>
                <!--<a href="">お問い合わせ</a>-->
